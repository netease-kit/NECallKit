...
package com.netease.yunxin.app.videocall.order;
...
public class CallOrderManager {
    ...
    executorService.submit(
        () -> {
          try {
            ...
            ALog.i(
                "CallOrderManager", "loadOrders currentUser accountId:" + currentUser.getAccount());
            String orderStr =
                SPUtils.getInstance(RECENTLY_CALL_ORDERS + currentUser.getAccount())
            ...
            new Callback2<List<UserModel>>() {
              ...
              public void onSuccess(List<UserModel> userModels) {
                if (userModels == null || userModels.isEmpty()) {
                  ALog.e(TAG, "fetchUserInfo success but list is empty. ");
                  return;
                }
  ...
  private void uploadOrder() {
    ...
    UserModel currentUser = LoginManager.getInstance().getUserModel();
    ALog.i("CallOrderManager", "uploadOrder currentUser accountId:" + currentUser.getAccount());
    SPUtils.getInstance(RECENTLY_CALL_ORDERS + currentUser.getAccount()).put(ORDER_LIST, orderStr);
  }
