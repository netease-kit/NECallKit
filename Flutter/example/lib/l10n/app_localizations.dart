...
abstract class AppLocalizations {
  ...
  /// No description provided for @nertc.
  ///
  ...
  /// No description provided for @desktop_log_directory.
  ///
  /// In en, this message translates to:
  /// **'Desktop log directory'**
  String get desktop_log_directory;
  ...
  /// No description provided for @open_log_directory_failed.
  ///
  /// In en, this message translates to:
  /// **'Failed to open log directory'**
  String get open_log_directory_failed;
  ...
  /// No description provided for @call_records.
  ///
  /// In en, this message translates to:
  /// **'Call Records'**
  String get call_records;
  ...
  /// No description provided for @how_to_get_account_token.
  ///
  /// In en, this message translates to:
  /// **'How to get NetEase account and Token'**
  String get how_to_get_account_token;

  /// No description provided for @sample_login_desc.
  ///
  /// In en, this message translates to:
  /// **'Please enter your NetEase account and Token to start exploring'**
  String get sample_login_desc;

  /// No description provided for @enter_account.
  ///
  /// In en, this message translates to:
  /// **'Please enter account'**
  String get enter_account;

  /// No description provided for @enter_token.
  ///
  /// In en, this message translates to:
  /// **'Please enter Token'**
  String get enter_token;

  /// No description provided for @please_enter_account.
  ///
  /// In en, this message translates to:
  /// **'Please enter NetEase account'**
  String get please_enter_account;

  /// No description provided for @please_enter_token.
  ///
  /// In en, this message translates to:
  /// **'Please enter account Token'**
  String get please_enter_token;
