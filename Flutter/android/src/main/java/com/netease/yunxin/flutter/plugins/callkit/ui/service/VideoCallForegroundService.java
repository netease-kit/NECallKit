...
public class VideoCallForegroundService extends Service {
  ...
  public static void start(Context context) {
    if (isServiceRunning(context, VideoCallForegroundService.class.getName())) {
      return;
    }
    Intent starter = new Intent(context, VideoCallForegroundService.class);
  ...
  public static void stop(Context context) {
    Intent intent = new Intent(context, VideoCallForegroundService.class);
  ...
  public void onCreate() {
    ...
    try {
      ...
      // Android 14+: foregroundServiceType=camera|microphone requires runtime permissions granted.
