...
#import "NECallKitPIPRenderer.h"
#include <NEDyldYuv/Libyuv.h>

@interface NECallKitPIPRenderer ()
@end

@implementation NECallKitPIPRenderer
+ (instancetype)renderWithUserUuid:(NSString *)userUuid {
  NECallKitPIPRenderer *renderer = [self new];
  renderer.userUuid = userUuid;
  return renderer;
}

- (void)onNERtcEngineRenderFrame:(NERtcVideoFrame *)frame {
