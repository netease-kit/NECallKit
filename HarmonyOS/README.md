...
**问题**: 编译时提示找不到 `@nertc/nertc_sdk` 或其他模块
...
- **云信文档**: [https://doc.yunxin.163.com/](https://doc.yunxin.163.com/)
- **问题反馈**: 通过 GitHub Issues 或联系技术支持
