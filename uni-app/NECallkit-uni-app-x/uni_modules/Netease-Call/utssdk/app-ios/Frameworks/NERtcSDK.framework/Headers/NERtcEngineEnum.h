...
typedef NS_ENUM(NSInteger, NERtcFeatureSupportType) {
  /**
   * @if English
   ...
   * @endif
   */
  kNERtcFeatureSupportFull = 0,
  
  /**
   * @if English
   * Due to equipment hardware or system reasons, the current device does not support the feature.
   * @endif
   * @if Chinese
  ...
  /**
   * @if English
   * Because the equipment performance is insufficient, the feature is not supported, but it can be forced to open. For example, low-performance devices are forced to enable the virtual background function by setting the \ref nertc::IRtcEngineEx::enableVirtualBackground "enableVirtualBackground" interface in `YES` force mode.
   * @endif
   * @if Chinese
   * 由于设备性能不足，不支持该功能，但可以强制打开。例如，低性能设备通过设置 \ref nertc::IRtcEngineEx::enableVirtualBackground "enableVirtualBackground" 接口的 `force` 为 `YES`，从而强制开启虚拟背景功能。
   * @endif
   */
...
typedef NS_ENUM(NSUInteger, NERtcVideoStreamLayerCount) {
  /**
   * @if Chinese
   * 单流。
   * @endif
 ...
 * @if Chinese
 * 视频帧率。
 * - kNERtcVideoFrameRateFpsDefault：主流默认根据设置的 maxProfile 选择， 辅流默认 kNERtcVideoFrameRateFps7。
 * @endif
 */
 ...
 * 带宽受限时视频编码适应性偏好
 * - kNERtcDegradationDefault:
 * <br>通信场景(kNERtcChannelProfileCommunication),使用 Balanced。
 * <br>直播场景(kNERtcChannelProfileLiveBroadcasting),使用 MaintainQuality。
 ...
 * 视频颜色范围。
 */
typedef NS_ENUM(NSInteger, NERtcVideoColorSpaceRange) {
    /**
     * @if English
     * Unspecified.
     * @endif
     */
    kNERtcVideoColorSpaceRangeInvalid = 0,
    /**
     * @if English
     * Limited range.
     * @endif
     */
    kNERtcVideoColorSpaceRangeLimited = 1,
    /**
     * @if English
     * Full range.
     * @endif
     */
    kNERtcVideoColorSpaceRangeFull = 2,
    /**
     * @if English
     * Derived range.
     * @endif
     */
    kNERtcVideoColorSpaceRangeDerived = 3,
};
 ...
 * @endif
 */
typedef NS_ENUM(NSInteger, NERtcVideoColorSpaceMatrix) {
    /**
     * @if English
     * RGB.
     * @endif
     ...
     * @endif
     */
    kNERtcVideoColorSpaceMatrixRGB = 0,
    /**
     * @if English
     * BT.709.
     * @endif
     ...
     * @endif
     */
    kNERtcVideoColorSpaceMatrixBT709 = 1,
    /**
     * @if English
     * Unspecified.
     * @endif
     ...
     * @endif
     */
    kNERtcVideoColorSpaceMatrixUNSPECIFIED = 2,
    /**
     * @if English
     * FCC.
     * @endif
     ...
     * @endif
     */
    kNERtcVideoColorSpaceMatrixFCC = 4,
    /**
     * @if English
     * BT.470BG.
     * @endif
     ...
     * @endif
     */
    kNERtcVideoColorSpaceMatrixBT470BG = 5,
    /**
     * @if English
     * SMPTE170M.
     * @endif
     ...
     * @endif
     */
    kNERtcVideoColorSpaceMatrixSMPTE170M = 6,
    /**
     * @if English
     * SMPTE240M.
     * @endif
     ...
     * @endif
     */
    kNERtcVideoColorSpaceMatrixSMPTE240M = 7,
    /**
     * @if English
     * YCOCG.
     * @endif
     ...
     * @endif
     */
    kNERtcVideoColorSpaceMatrixYCOCG = 8,
    /**
     * @if English
     * BT2020NCL.
     * @endif
     ...
     * @endif
     */
    kNERtcVideoColorSpaceMatrixBT2020NCL = 9,
    /**
     * @if English
     * BT2020CL.
     * @endif
     ...
     * @endif
     */
    kNERtcVideoColorSpaceMatrixBT2020CL = 10,
    /**
     * @if English
     * SMPTE2085.
     * @endif
     ...
     * @endif
     */
    kNERtcVideoColorSpaceMatrixSMPTE2085 = 11,
    /**
     * @if English
     * CDNCLS.
     * @endif
     ...
     * @endif
     */
    kNERtcVideoColorSpaceMatrixCDNCLS = 12,
    /**
     * @if English
     * CDCLS.
     * @endif
     ...
     * @endif
     */
    kNERtcVideoColorSpaceMatrixCDCLS = 13,
    /**
     * @if English
     * BT2100ICTCP.
     * @endif
     ...
     * @endif
     */
    kNERtcVideoColorSpaceMatrixBT2100ICTCP = 14,
    /**
     * @if English
     * Invalid.
     * @endif
     ...
     * @endif
     */
    kNERtcVideoColorSpaceMatrixInvalid = 63,
};
 ...
 * @endif
 */
typedef NS_ENUM(NSInteger, NERtcVideoColorSpacePrimary) {
    /**
     * @if English
     * Unspecified.
     * @endif
     ...
     * @endif
     */
    kNERtcVideoColorSpacePrimaryInvalid = 0,
    /**
     * @if English
     * BT.709.
     * @endif
     ...
     * @endif
     */
    kNERtcVideoColorSpacePrimaryBT709 = 1,
    /**
     * @if English
     * Unspecified.
     * @endif
     ...
     * @endif
     */
    kNERtcVideoColorSpacePrimaryUNSPECIFIED = 2,
    /**
     * @if English
     * BT.470M.
     * @endif
     ...
     * @endif
     */
    kNERtcVideoColorSpacePrimaryBT470M = 4,
    /**
     * @if English
     * BT.470BG.
     * @endif
     ...
     * @endif
     */
    kNERtcVideoColorSpacePrimaryBT470BG = 5,
    /**
     * @if English
     * SMPTE170M (Identical to BT601).
     * @endif
     * @if Chinese
     * SMPTE170M（与BT601相同）。
     * @endif
     */
    kNERtcVideoColorSpacePrimarySMPTE170M = 6,
    /**
     * @if English
     * SMPTE240M.
     * @endif
     ...
     * @endif
     */
    kNERtcVideoColorSpacePrimarySMPTE240M = 7,
    /**
     * @if English
     * FILM.
     * @endif
     ...
     * @endif
     */
    kNERtcVideoColorSpacePrimaryFILM = 8,
    /**
     * @if English
     * BT.2020.
     * @endif
     ...
     * @endif
     */
    kNERtcVideoColorSpacePrimaryBT2020 = 9,
    /**
     * @if English
     * SMPTEST428.
     * @endif
     ...
     * @endif
     */
    kNERtcVideoColorSpacePrimarySMPTEST428 = 10,
    /**
     * @if English
     * SMPTEST431.
     * @endif
     ...
     * @endif
     */
    kNERtcVideoColorSpacePrimarySMPTEST431 = 11,
    /**
     * @if English
     * SMPTEST432.
     * @endif
     ...
     * @endif
     */
    kNERtcVideoColorSpacePrimarySMPTEST432 = 12,
    /**
     * @if English
     * JEDECP22 (Identical to EBU3213-E).
     * @endif
     * @if Chinese
     * JEDECP22（与EBU3213-E相同）。
     * @endif
     */
    kNERtcVideoColorSpacePrimaryJEDECP22 = 22,
};
 ...
 * @endif
 */
typedef NS_ENUM(NSInteger, NERtcVideoColorSpaceTransfer) {
    /**
     * @if English
     * Unspecified.
     * @endif
     ...
     * @endif
     */
    kNERtcVideoColorSpaceTransferInvalid = 0,
    /**
     * @if English
     * BT.709.
     * @endif
     ...
     * @endif
     */
    kNERtcVideoColorSpaceTransferBT709 = 1,
    /**
     * @if English
     * Unspecified.
     * @endif
     ...
     * @endif
     */
    kNERtcVideoColorSpaceTransferUNSPECIFIED = 2,
    /**
     * @if English
     * GAMMA22.
     * @endif
     ...
     * @endif
     */
    kNERtcVideoColorSpaceTransferGAMMA22 = 4,
    /**
     * @if English
     * GAMMA28.
     * @endif
     ...
     * @endif
     */
    kNERtcVideoColorSpaceTransferGAMMA28 = 5,
    /**
     * @if English
     * SMPTE170M.
     * @endif
     ...
     * @endif
     */
    kNERtcVideoColorSpaceTransferSMPTE170M = 6,
    /**
     * @if English
     * SMPTE240M.
     * @endif
     ...
     * @endif
     */
    kNERtcVideoColorSpaceTransferSMPTE240M = 7,
    /**
     * @if English
     * LINEAR.
     * @endif
     ...
     * @endif
     */
    kNERtcVideoColorSpaceTransferLINEAR = 8,
    /**
     * @if English
     * LOG.
     * @endif
     ...
     * @endif
     */
    kNERtcVideoColorSpaceTransferLOG = 9,
    /**
     * @if English
     * LOG_SQRT.
     * @endif
     ...
     * @endif
     */
    kNERtcVideoColorSpaceTransferLOG_SQRT = 10,
    /**
     * @if English
     * IEC61966_2_4.
     * @endif
     ...
     * @endif
     */
    kNERtcVideoColorSpaceTransferIEC61966_2_4 = 11,
    /**
     * @if English
     * BT1361_ECG.
     * @endif
     ...
     * @endif
     */
    kNERtcVideoColorSpaceTransferBT1361_ECG = 12,
    /**
     * @if English
     * IEC61966_2_1.
     * @endif
     ...
     * @endif
     */
    kNERtcVideoColorSpaceTransferIEC61966_2_1 = 13,
    /**
     * @if English
     * BT2020_10.
     * @endif
     ...
     * @endif
     */
    kNERtcVideoColorSpaceTransferBT2020_10 = 14,
    /**
     * @if English
     * BT2020_12.
     * @endif
     ...
     * @endif
     */
    kNERtcVideoColorSpaceTransferBT2020_12 = 15,
    /**
     * @if English
     * SMPTEST2084.
     * @endif
     ...
     * @endif
     */
    kNERtcVideoColorSpaceTransferSMPTEST2084 = 16,
    /**
     * @if English
     * SMPTEST428.
     * @endif
     ...
     * @endif
     */
    kNERtcVideoColorSpaceTransferSMPTEST428 = 17,
    /**
     * @if English
     * ARIB_STD_B67.
     * @endif
     ...
     * @endif
     */
    kNERtcVideoColorSpaceTransferARIB_STD_B67 = 18,
};
...
typedef NS_ENUM(NSInteger, NERtcAudioProfileType) {
    ...
    /**
     * @if English
     * Medium sound quality mode. Sample rate: 48 kHz, music encoding, mono, and maximum bitrate: 48 kbps.
     * @endif
     * @if Chinese
 ...
 * @endif
 */
typedef NS_ENUM(NSInteger, NERtcAudioAINSMode) {
    /**
     * @if English
     * Turn off AINS.
     * @endif
...
typedef NS_ENUM(NSInteger, NERtcChannelProfileType) {
    ...
    /**
     * @if English
     * Video 1-on-1 Call Scenario. This scenario involves turning off the video substream mode, automatically turning on video, automatically subscribing to video, setting the video format to 640x360/480 at 15 fps, employing a transmission strategy that preserves clarity with high bitrate, using an audio encoding sampling rate of 16k, and specifying an audio bitrate of 20kbps.
     * @since V5.5.40
     * @endif
     * @if Chinese
     * 视频 1 对 1 呼叫场景。该场景会关闭视频大小流模式、自动打开视频、自动订阅视频、视频格式为 640x360/480 @ 15 fps、传输策略为保清晰度，高码流、音频编码采样率为 16k，码率为 20kbps。
     * @since V5.5.40
     * @endif
     */
    ...
    /**
     * @if English
     * Higher Clarity 1-on-1 Call Scenario. This scenario involves disabling the video substream mode, automatically activating video, and auto-subscribing to video. The video format is set at 960x540 running at 15 frames per second (fps). The transmission strategy focuses on maintaining clarity with a high bitrate. Audio encoding utilizes a sample rate of 16 kilohertz (kHz), with the audio bitrate specified at 20 kilobits per second (kbps).
     * @since V5.5.40
     * @endif
     * @if Chinese
     * 清晰度较高的 1 对 1 呼叫场景。该场景会关闭视频大小流模式、自动打开视频、自动订阅视频、视频格式为 960x540 @ 15 fps、传输策略为保清晰度，高码流、音频编码采样率为 16k，码率为 20kbps。
     * @since V5.5.40
     * @endif
     */
     ...
     * @endif
     * @if Chinese
     * 高品质语聊房场景。该场景会关闭视频大小流模式、关闭自动打开视频、关闭自动订阅视频、视频格式为 640x360/480 @ 15 fps、传输策略为保清晰度，高码流、音频编码采样率为 48k，码率为 96kbps。
     * @since V5.5.40
     * @endif
     */
     ...
     * @endif
     * @if Chinese
     * 会议场景。该场景会打开视频三流模式、关闭自动打开视频、关闭自动订阅视频、视频格式为 1280x720/ @ 30 fps、传输策略为清晰度和帧率平衡，低码流、音频编码采样率为 24k，码率为 48kbps。
     * @since V5.5.40
     * @endif
     */
 ...
 * 视频 dump 类型
 */
typedef NS_ENUM(NSInteger, NERtcVideoDumpType) {
  /** 
   * 无效类型，等同于清除 dump。 
  */
  kNERtcVideoDumpTypeClear = 0,

  /**
   * 停止 dump 并上传。
   */
  kNERtcVideoDumpTypeStopAndUpload = 1,

  /**
   * 发送和接收视频 dump。
   */
  kNERtcVideoDumpTypeSendAndReceive = 2,

  /**
   * 仅发送视频 dump。
   */
  kNERtcVideoDumpTypeSend = 3,

  /**
   * 仅接收视频 dump。
   */
  kNERtcVideoDumpTypeReceive = 4,

  /**
   * 发送和接收 dump并循环覆写。
   */
  kNERtcVideoDumpTypeSendAndReceiveLoop = 5,

  /**
   * 仅发送 dump并循环覆写。
   */
  kNERtcVideoDumpTypeSendAndLoop = 6,

  /**
   * 仅接收 dump并循环覆写。
   */
  kNERtcVideoDumpTypeReceiveAndLoop = 7
};
...
typedef NS_ENUM(int, NERtcIPAddrMode) {
    /**
     * Use IPv4 Only
     */
    kNERtcIPAddrV4Only = 0,
    /**
     * Use IPv4 and IPv6
     */
    kNERtcIPAddrV4AndV6 = 1,
};

#pragma mark - asr
typedef NS_ENUM(int, NERtcAsrCaptionState) {
  /**
   * @if Chinese
   * 启动失败
   * @endif
   */
  kNERtcAsrCaptionStartFailed = 0,
  /**
   * @if Chinese
   * 停止失败
   * @endif
   */
  kNERtcAsrCaptionStateStopFailed = 1,
  /**
   * @if Chinese
   * 已经启动
   * @endif
   */
  kNERtcAsrCaptionStateStarted = 2,
  /**
   * @if Chinese
   * 已经停止
   * @endif
   */
  kNERtcAsrCaptionStateStopped = 3
};

#pragma mark - live play stream

typedef NS_ENUM(int, NERtcLivePlayStreamState) {
    /**
   * @if Chinese
   * 直播播放状态：未启动
   * @endif
   */
  kNERtcLivePlayStreamStateIdle = 0,
  /**
   * @if Chinese
   * 直播播放状态：播放中
   * @endif
   */
  kNERtcLivePlayStreamStatePlaying = 1,
  /**
   * @if Chinese
   * 直播播放状态：暂停
   * @endif
   */
  kNERtcLivePlayStreamStatePaused = 2,
  /**
   * @if Chinese
   * 直播播放状态：重连中
   * @endif
   */
  kNERtcLivePlayStreamStateReconnecting = 3,
  /**
   * @if Chinese
   * 直播播放状态：已停止
   * @endif
   */
  kNERtcLivePlayStreamStateStopped = 4,
};

typedef NS_ENUM(NSInteger, NERtcMultiPathMediaMode) {
  /**
   * @if Chinese
   * 同一数据多链路同步传输模式
   * @endif
  */
  NERtcMultiPathMediaModeRed = 0,
  /**
   * @if Chinese
   * 当前链路质量变差时切换另外链路模式
   * @endif
   */
  NERtcMultiPathMediaModeSwitch = 1,
};
