...
/// app 内语言环境工具类
SWIFT_CLASS("_TtC11NECommonKit17NEAppLanguageUtil")
@interface NEAppLanguageUtil : NSObject
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) UIWindowScene * _Nullable windowScene;)
