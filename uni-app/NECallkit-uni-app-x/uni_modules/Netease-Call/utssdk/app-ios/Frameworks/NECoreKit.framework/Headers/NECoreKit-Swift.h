...
SWIFT_CLASS("_TtC9NECoreKit11NERouterUrl")
@interface NERouterUrl : NSObject
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull LocationVCRouter;)
+ (NSString * _Nonnull)LocationVCRouter SWIFT_WARN_UNUSED_RESULT;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull LocationSearchResult;)
+ (NSString * _Nonnull)LocationSearchResult SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
