...
@interface NIMSRSecurityPolicy : NSObject

/**
 A default `NIMSRSecurityPolicy` implementation specifies socket security and
 validates the certificate chain.

 Use a subclass of `NIMSRSecurityPolicy` for more fine grained customization.
 */
