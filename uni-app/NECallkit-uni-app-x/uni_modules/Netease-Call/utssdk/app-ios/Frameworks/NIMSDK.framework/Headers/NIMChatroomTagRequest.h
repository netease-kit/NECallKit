 ...
 * X坐标
 */
@property (nonatomic, copy, nullable) NSNumber *locationX;
/**
 * Y坐标
 */
@property (nonatomic, copy, nullable) NSNumber *locationY;
/**
 * Z坐标
 */
@property (nonatomic, copy, nullable) NSNumber *locationZ;
/**
 * 距离
 */
@property (nonatomic, copy, nullable) NSNumber *distance;
@end
