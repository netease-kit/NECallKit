...
@class V2NIMMessageCustomAttachment;
...
/// 构造自定义消息消息 自定义对象必须给raw赋值
/// @param text 需要发送的文本内容
/// @param rawAttachment 需要发送的附件
+ (V2NIMChatroomMessage *)createCustomMessageWithAttachment:(V2NIMMessageCustomAttachment *)attachment 
                                                    subType:(int)subType;
