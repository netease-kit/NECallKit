...
@class NIMQChatGetUncategorizedChannelsByPageParam;
...
@class NIMQChatGetUncategorizedChannelsByPageResult;
...
@class NIMQChatChannelMuteParam;
@class NIMQChatMuteResult;
@class NIMQChatGetChannelMuteMemberByPageParam;
@class NIMQChatGetChannelMuteMemberByPageResult;
 ...
 * @param result 回调结果
 */
typedef void(^NIMQChatGetUncategorizedChannelsByPageHandler)(NSError *__nullable error,
                                                             NIMQChatGetUncategorizedChannelsByPageResult *__nullable result);
