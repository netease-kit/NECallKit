...
/**
 *  消息机器人信息
 *  @discussion 设置和获取消息的机器人相关信息
 */
@property (nullable, nonatomic, strong) NIMMessageRobotInfo *robotInfo;

/**
 * 请求大模型的相关参数
 */
@property(nullable,nonatomic,strong,readwrite) NIMMessageAIConfigParams *sendAIConfig;
...
/// 流式配置
@property(nullable,nonatomic,strong,readonly) NIMMessageStreamConfig *streamConfig;
@end
