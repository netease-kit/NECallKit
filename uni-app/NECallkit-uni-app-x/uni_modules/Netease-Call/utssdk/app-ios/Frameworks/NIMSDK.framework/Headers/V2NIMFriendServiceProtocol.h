...
typedef void (^V2NIMGetApplicationUnreadCountSuccess)(NSInteger count);

typedef void (^V2NIMSetApplicationReadSuccess)(BOOL success);
 ...
 * 根据关键字搜索好友信息
 *
 * @param friendSearchOption 更新自己的好友资料参数
 * @param success  更新好友资料成功的回调
 * @param failure  更新好友资料失败的回调
 */
 ...
 *
 */
@property (nullable,nonatomic,copy) NSString *applicantAccountId;
/**
 *  被申请者账号
 *
 */
@property (nullable,nonatomic,copy) NSString *recipientAccountId;
/**
 *  操作者账号
 *
 */
@property (nullable,nonatomic,copy) NSString *operatorAccountId;
/**
 *  申请添加好友的附言
 *
 */
 ...
 *
 */
@property (nonatomic, assign) V2NIMFriendAddApplicationStatus status;
/**
 *  操作的时间
 *
 */
