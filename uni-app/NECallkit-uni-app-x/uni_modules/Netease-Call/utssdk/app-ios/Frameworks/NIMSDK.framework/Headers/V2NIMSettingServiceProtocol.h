...
/// 成功接收获取我所在的群消息免打扰模式结果回调
typedef void (^V2NIMGetAllTeamMessageMuteModeCallback)(NSDictionary<NSString *, NSNumber *> *result);
...
// *  @param teamType 群组类型
// *
// *  @return 返回字典，key是teamId, value是V2NIMTeamMessageMuteMode
// */
//- (nullable NSDictionary<NSString *, NSNumber *> *)getAllTeamMessageMuteMode:(V2NIMTeamType)teamType;
