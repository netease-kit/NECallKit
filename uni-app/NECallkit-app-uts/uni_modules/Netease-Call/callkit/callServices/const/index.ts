...
export const CALL_DATA_KEY = {
  ...
  CALL_EXTRA_INFO: "callExtraInfo",
  CALL_DURATION: "callDuration",
  CALL_TIPS: "callTips",
  LANGUAGE: "language",
  CHAT_GROUP_ID: "chatGroupID",
  ENABLE_FLOAT_WINDOW: "enableFloatWindow",
  ENABLE_INCOMING_BANNER: "enableIncomingBanner",
  IS_IN_INCOMING_BANNER: "isInIncomingBanner",
...
export const CALL_PAGE_PATH = "/uni_modules/Netease-Call/callkit/callPage";
