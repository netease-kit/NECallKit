import { INEStore, IOptions, Task } from "../interface/INEStore";
import { StoreName, NAME } from "../const/index";
import CallStore from "./callStore";
import { isString, isNumber, isBoolean } from "../utils/index";

export default class NEStore implements INEStore {
  static instance: NEStore;
  public task: Task;
  ...
  static getInstance() {
    if (!NEStore.instance) {
      NEStore.instance = new NEStore();
    }
    return NEStore.instance;
  }
